...
(function ($) {
    ...
    function blog_init() {
        ...
        if (blog_grid) {
            ...
            blog_filter.on("click", ".filter", function (e) {
                ...
                $(this).parent().addClass('active');
                blog_grid.shuffle('shuffle', $(this).attr('data-group'));
            });
    ...
    $(function () {
        ...
        $('#contact-form').on('submit', function (e) {
            if (!e.isDefaultPrevented()) {
                var url = "https://formspree.io/xyynbpgl";
    ...
    $(document).on('ready', function () {
        ...
        // Blog hover effect init
        $(' #blog_grid > figure > a ').each(function () { $(this).hoverdir(); });
